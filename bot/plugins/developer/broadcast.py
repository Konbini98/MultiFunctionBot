...
@Client.on_message(filters.command(commands, prefixes=prefixes))
@dev_commands
async def broadcast(c, m):
    out = await m.reply_text(
        text="Broadcast initiated! You will be notified with a log file when all the users are notified."
    )
